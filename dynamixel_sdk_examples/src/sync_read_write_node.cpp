...
// $ ros2 topic pub -1 /set_position dynamixel_sdk_custom_interfaces/SetPosition "{id: [0, 1, 2, 3], position: [0, 1000, 2000, 3000]}"
    ...
    [this](const SetPosition::SharedPtr msg) -> void
    {
      ...
      for(int i = 0; i <= lenght; i++){
        ...
        if (dxl_comm_result != COMM_SUCCESS) {
          ...
          RCLCPP_INFO(this->get_logger(), "Set [ID: %d] [Goal Position: %d]", msg->id[i], msg->position[i]);
        }
      }
